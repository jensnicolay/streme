...
public class BeaverPrimitives
{
  ...
  public static final class EqP extends Procedure
  {
    ...
    {
      if (operand1 instanceof Number || operand1 instanceof BigInteger)
      {
    ...
    public Callable<Callable> apply2(Object operand1, Object operand2, LstEnv env, TCont cont)
    {
      return cont.call(eq(operand1, operand2));
    }
  }

  public static final class EqvP extends Procedure
  {
    public static final boolean eqv(Object o1, Object o2)
    {
      if (o1 instanceof Number || o1 instanceof BigRational)
      {
        return o1.equals(o2);
      }
      return o1 == o2;
    ...
    public Callable<Callable> apply2(Object operand1, Object operand2, LstEnv env, TCont cont)
    {
      return cont.call(eqv(operand1, operand2));
    }
  }
  ...
  public static final class EqualP extends Procedure
  {
    public static final boolean equal(Object o1, Object o2)
    {
      ...
      // return o1.equals(o2);
      // }
      // return EqvP.eqv(o1, o2);
      return o1.equals(o2);
    }

    public Callable<Callable> apply2(Object operand1, Object operand2, LstEnv env, TCont cont)
    {
      return cont.call(equal(operand1, operand2));
    }
  }
  ...
  public static final class Member extends Procedure
  {
    public Callable<Callable> apply2(Object candidate, Object list, LstEnv env, TCont cont)
    {
      ...
      {
        Pair p = (Pair) list;
        if (EqualP.equal(candidate, p.car()))
        {
          return cont.call(list);
        }
        list = p.cdr();
  ...
  public static final class Assoc extends Procedure // UNTESTED
  {
    public Callable<Callable> apply2(Object candidate, Object list, LstEnv env, TCont cont)
    {
      while (!(list instanceof Null))
      {
        Pair p = (Pair) list;
        Pair c = (Pair) p.car();
        if (EqualP.equal(candidate, c.car()))
        {
          return cont.call(c);
        }
        list = p.cdr();
